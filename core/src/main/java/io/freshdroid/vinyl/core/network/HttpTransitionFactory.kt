...
class HttpTransitionFactory @Inject constructor(
    ...
    override fun create(headers: Map<String, String>?,
    ...
    private fun get(headers: Map<String, String>?,
    ...
    private fun post(headers: Map<String, String>?,
                     httpTransition: HttpTransition,
                     body: String?,
                     multipartBody: MultipartBody.Part?
    ): Observable<Response<String>> {
    ...
    private fun put(headers: Map<String, String>?, httpTransition: HttpTransition, body: String?): Observable<Response<String>> {
        val contentType = httpTransition.accept ?: DEFAULT_CONTENT_TYPE
        val headerMap = hashMapOf(Pair(KEY_HEADER_CONTENT_TYPE, contentType))
        headers?.let { headerMap.putAll(it) }
    ...
    private fun patch(headers: Map<String, String>?, httpTransition: HttpTransition, body: String?): Observable<Response<String>> {
        val contentType = httpTransition.accept ?: DEFAULT_CONTENT_TYPE
        val headerMap = hashMapOf(Pair(KEY_HEADER_CONTENT_TYPE, contentType))
        headers?.let { headerMap.putAll(it) }
    ...
    private fun delete(headers: Map<String, String>?, httpTransition: HttpTransition, body: String?): Observable<Response<String>> {
        val contentType = httpTransition.accept ?: DEFAULT_CONTENT_TYPE
        val headerMap = hashMapOf(Pair(KEY_HEADER_CONTENT_TYPE, contentType))
        headers?.let { headerMap.putAll(it) }
